...
Future<void> typeIntoElement({
  ...
  if (controller != null) {
    ...
    developer.log(
      '[ai-test-v3] ext.aitest.type: primary path unavailable, using '
...
Future<void> pressKey({
  ...
  if (logicalKey == null) {
    throw ArgumentError(
      '[ai-test-v3] ext.aitest.press_key: unknown key "$key". '
...
/// Handler for the `ext.aitest.type` VM Service extension.
///
  ...
  try {
    ...
    if (ref == null || ref.isEmpty) {
      return developer.ServiceExtensionResponse.error(
        ...
        '[ai-test-v3] ext.aitest.type: missing required param "ref"',
      );
    }
    ...
    if (element == null) {
      return developer.ServiceExtensionResponse.error(
        developer.ServiceExtensionResponse.extensionError,
        '[ai-test-v3] ext.aitest.type: ref "$ref" not found in registry',
      );
    }
    ...
    developer.log(
      '[ai-test-v3] ext.aitest.type error: $e\n$stackTrace',
      name: 'ai-test',
    );
    return developer.ServiceExtensionResponse.error(
      developer.ServiceExtensionResponse.extensionError,
...
/// Handler for the `ext.aitest.press_key` VM Service extension.
///
/// Params:
...
Future<developer.ServiceExtensionResponse> aiTestPressKeyHandler(
  ...
  try {
    ...
    if (key == null || key.isEmpty) {
      return developer.ServiceExtensionResponse.error(
        developer.ServiceExtensionResponse.extensionError,
        '[ai-test-v3] ext.aitest.press_key: missing required param "key"',
      );
    }
    ...
    developer.log(
      '[ai-test-v3] ext.aitest.press_key error: $e\n$stackTrace',
      name: 'ai-test',
    );
    return developer.ServiceExtensionResponse.error(
      developer.ServiceExtensionResponse.extensionError,
...
/// Registers `ext.aitest.type` and `ext.aitest.press_key` as VM Service
/// extensions.
///
...
void registerTextInputExtensions() {
  registerExtensionIdempotent('ext.aitest.type', aiTestTypeHandler);
  registerExtensionIdempotent('ext.aitest.press_key', aiTestPressKeyHandler);
}
