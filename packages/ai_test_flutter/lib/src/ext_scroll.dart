...
/// Registers the `ext.aitest.scroll` and `ext.aitest.select_option` VM Service
/// extensions.
///
...
void registerScrollExtensions() {
  registerExtensionIdempotent('ext.aitest.scroll', aiTestScrollHandler);
...
/// Handler for the `ext.aitest.scroll` VM Service extension.
///
/// Params:
...
Future<developer.ServiceExtensionResponse> aiTestScrollHandler(
  ...
  try {
    ...
    developer.log(
      '[ai-test-v3] ext.aitest.scroll error: $e\n$stackTrace',
      name: 'ai-test',
    );
    return developer.ServiceExtensionResponse.error(
      developer.ServiceExtensionResponse.extensionError,
...
///
/// Used when no `ref` parameter is supplied to `ext.aitest.scroll`. Walks the
...
/// Handler for the `ext.aitest.select_option` VM Service extension.
///
...
Future<developer.ServiceExtensionResponse> aiTestSelectOptionHandler(
  ...
  try {
    ...
    developer.log(
      '[ai-test-v3] ext.aitest.select_option error: $e\n$stackTrace',
      name: 'ai-test',
    );
    return developer.ServiceExtensionResponse.error(
      developer.ServiceExtensionResponse.extensionError,
